package engine.physics.movement 
{
	...
	public class FlightPhysics implements ITickable
	{
		...
		{
			velocity.x = Math.cos(MathHelper.degreesToRadians(rotation));
			velocity.y = Math.sin(MathHelper.degreesToRadians(rotation));
